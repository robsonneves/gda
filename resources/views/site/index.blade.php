...
@section('content')
    ...
    @if(Auth::guest())
        ...
        <section class="intro">
            ...
            @include('auth.sitelogin')
        </section>
        <!-- Section: #CONTACT -->
   
        {{--
         <section id="contact" class="home-section text-center" style="margin: -300px 0px 250px;">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-offset-2">
                        <div class="boxed-grey">
                            <form id="form-controller" data-type="post" method="post" action="contato">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="email" class="pull-left"> Endereço de email <i class="fa fa-envelope"></i>
                                            </label>
                                            <br>
